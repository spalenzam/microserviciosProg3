...
public class CursoController extends CommonController<Curso, CursoService> {
	...
	//Creamos dos métodos para modificar alumnos (ya que hay relación con esa clase)
	//Acá usamos un list porque va aparecer una lista y vamos a ir clickeando los alumnos que queremos agregar
	...
	public ResponseEntity<?> asignarAlumnos(@RequestBody List<Alumno> alumnos, @PathVariable Long id){
		...
		//iteramos la lista de alumnos y lo vamos agregando al curso con el método add
		alumnos.forEach(a -> {
	...
	//Acá no lo hacemos como lista, sino que ponemos un alumno determinado 
